...
<head>
    ...
    <script src="../../Scripts/adminVeicoliScript.js"></script>
    ...
    <div class="mx-4">
        ...
        <table class="table w-full mt-12 text-left divide-y divide-gray-200 rounded-lg">
            <thead class="bg-slate-200 rounded-tl-lg rounded-tr-lg">
                <tr class="">
                    <th class="px-6 py-5 text-md font-bold text-black uppercase tracking-wider">Targa</th>
                    <th class="px-6 py-5 text-md font-bold text-black uppercase tracking-wider">Modello</th>
                    <th class="px-6 py-5 text-md font-bold text-black uppercase tracking-wider">Marca</th>
                    <th class="px-6 py-5 text-md font-bold text-black uppercase tracking-wider">CF Proprietario</th>
                </tr>
                </thead>
