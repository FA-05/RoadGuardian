...
<head>
    ...
    <script src="../../Scripts/adminVigiliScript.js"></script>
...
<body>
    ...
    <div class="mx-4">
        ...
        <div role="tablist" class="tabs tabs-boxed w-[600px]">
            ...
            <a href="adminVigili.php" role="tab" class="tab tab-active">Vigili</a>
        ...
        <table class="table w-full mt-12 text-left divide-y divide-gray-200 rounded-lg">
            <thead class="bg-slate-200 rounded-tl-lg rounded-tr-lg">
                <tr class="">
                    <th class="px-6 py-5 text-md font-bold text-black uppercase tracking-wider">id-Vigile</th>
                    ...
                    <th class="px-6 py-5 text-md font-bold text-black uppercase tracking-wider">Telefono</th>
