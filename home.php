...
<body>
    ...
    <div id="page" class="mx-4 sm:mx-16">
        ...
        <div class="absolute left-[39vw] top-[15vh] md:top-[14vh] md:left-[42vw] ">
            <img class=" w-32 h-32 md:w-64 md:h-64  z-[-10]" src="assets/Icons/taxi-big-loudspeaker.gif" alt=""
        ...
        <section class="h-[30rem] flex flex-col md:flex-row justify-start">
            ...
            <div class="w-full md:w-1/2">
                <img class="h-48 md:h-96 mx-auto" src="assets/Icons/taxi-policeman.png" alt="">
            </div>
        </section>
        ...
        <section class="h-[39rem] flex flex-col md:flex-row items-center justify-start p-4">
            ...
            <div class="w-full md:w-1/3">
                <img class="mx-auto mb-4 md:mb-0" src="assets/Icons/Police-Barcode.png" alt="">
            </div>
