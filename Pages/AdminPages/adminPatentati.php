    ...
    <div class="mx-4">
        ...
        <table class="table w-full mt-12 text-left divide-y divide-gray-200 rounded-lg">
            <thead class="bg-slate-200 rounded-tl-lg rounded-tr-lg">
                <tr class="">
                    <th class="px-6 py-5 text-md font-bold text-black uppercase tracking-wider">CF</th>
                    <th class="px-6 py-5 text-md font-bold text-black uppercase tracking-wider">Nome</th>
                    <th class="px-6 py-5 text-md font-bold text-black uppercase tracking-wider">Cognome</th>
                    <th class="px-6 py-5 text-md font-bold text-black uppercase tracking-wider">Numero Patente</th>
                    <th class="px-6 py-5 text-md font-bold text-black uppercase tracking-wider">Punti Patente</th>
                    <th class="px-6 py-5 text-md font-bold text-black uppercase tracking-wider">Indirizzo</th>
                    <th class="px-6 py-5 text-md font-bold text-black uppercase tracking-wider">email</th>
                    <th class="px-6 py-5 text-md font-bold text-black uppercase tracking-wider">Patente Ritirata</th>
                </tr>
                </thead>
